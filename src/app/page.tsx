...
export default function Home() {
  return <><Header/><main id="conteudo"><Hero/><AboutPurpose/><ExpertiseMethod/><Differentials/><Services/><Experiences/><Practical/><FaqPortfolio/><ContactFooter/></main><FloatingWhatsApp/></>
}
